  ...
  useEffect(() => {
    const fetchTables = async () => {
      try {
        ...
        // Fetch volunteers
        const volunteersRes = await axios.get(`${serverUrl}/api/volunteers`, { withCredentials: true });
        setVolunteers(volunteersRes.data);

        // Fetch supervisors
        const supervisorsRes = await axios.get(`${serverUrl}/api/supervisors`, { withCredentials: true });
